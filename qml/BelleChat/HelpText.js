var mainHelp =
        ...
        + "</ul></br>"
        + "<h2>More Menu</h2>"
        + "<ul><li><b>Settings</b> Opens the Settings Page, which has two options:</li>"
        + "<ul><li><b>Server</b> Here you can change the server's settings.</li>"
        + "<li><b>Display</b> Here you can change various display-related settings, such as the colour of your messages.</li></ul>"
