...
# Generated by qmake (2.01a) (Qt 4.7.4) on: Fri 30. Mar 21:06:11 2012
# Project:  Bellechat.pro
# Template: app
# Command: c:\qtsdk\symbian\sdks\symbian3qt474\bin\qmake.exe -spec ..\..\QtSDK\Symbian\SDKs\Symbian3Qt474\mkspecs\symbian-sbsv2 QMLJSDEBUGGER_PATH=C:/QtSDK/Symbian/SDKs/Symbian3Qt474//qtc-qmldbg -after  OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc -o bld.inf Bellechat.pro
#############################################################################
...
DEFINES	 = -DSYMBIAN -DUNICODE -DQT_KEYPAD_NAVIGATION -DQT_SOFTKEYS_ENABLED -DQT_USE_MATH_H_FLOATS -DCOMMUNI_STATIC -DQMLJSDEBUGGER -DBUILD="\"0.9.1-4-gcc6c2b5\"" -DVERSIONNO="\"0.9.1\"" -DQ_COMPONENTS_SYMBIAN -DQT_DECLARATIVE_LIB -DQT_SCRIPT_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB
...
qmake:
	$(QMAKE) "C:/QtProjects/BelleChat/Bellechat.pro"  -spec ..\..\QtSDK\Symbian\SDKs\Symbian3Qt474\mkspecs\symbian-sbsv2 QMLJSDEBUGGER_PATH=C:/QtSDK/Symbian/SDKs/Symbian3Qt474//qtc-qmldbg -after  OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc
